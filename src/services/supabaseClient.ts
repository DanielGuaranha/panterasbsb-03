...
const MOCK_COMPANIONS: Companion[] = [
  {
    ...
    city: 'Brasília', neighborhood: 'Asa Sul',
  ...
  },
  {
    ...
    city: 'Brasília', neighborhood: 'Águas Claras',
  ...
  },
  {
    ...
    city: 'Brasília', neighborhood: 'Sudoeste',
    is_vip: true, created_at: new Date().toISOString(), featured_until: new Date(Date.now() + 864000000).toISOString(),
  ...
  },
  {
    ...
    city: 'Brasília', neighborhood: 'Lago Norte',
    is_vip: false, created_at: new Date().toISOString(), featured_until: null,
  ...
  },
  {
    ...
    city: 'Brasília', neighborhood: 'Asa Norte',
  ...
  },
  {
    ...
    city: 'Brasília', neighborhood: 'Taguatinga',
    is_vip: false, created_at: new Date().toISOString(), featured_until: null,
  ...
  },
  {
    ...
    city: 'Brasília', neighborhood: 'Noroeste',
    is_vip: true, created_at: new Date().toISOString(), featured_until: new Date(Date.now() + 864000000).toISOString(),
  ...
  },
  {
    ...
    city: 'Brasília', neighborhood: 'Park Way',
  ...
  },
  {
    ...
    city: 'Brasília', neighborhood: 'Guará',
    is_vip: false, created_at: new Date().toISOString(), featured_until: null,
  ...
  },
  {
    ...
    city: 'Brasília', neighborhood: 'Octogonal',
    is_vip: false, created_at: new Date().toISOString(), featured_until: new Date(Date.now() + 864000000).toISOString(),
